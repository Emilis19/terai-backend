...
public class ApplicationController {
    ...
    @PostMapping
    ResponseEntity<HttpStatus> createApplication(@RequestBody Application application) throws KeyAlreadyExistsException, NotFoundException {
        applicationService.addApplication(application);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @PutMapping("/{id}")
    ResponseEntity<HttpStatus> updateApplication(@RequestBody Application application, @PathVariable String id) throws NotFoundException {
